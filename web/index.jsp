...
<div class="selectButton">
    ...
    <button type="button" id="prevBtn" disabled onclick="prev()" class="btn-slide-left btn btn-success btn-sm margin-right">&lt;</button>
    <label class="fontColor" id="imageNo">********</label>
    <button type="button" id="nextBtn" disabled onclick="next()" class="btn-slide-right btn btn-success btn-sm margin-right">&gt;</button>
</div>
<div class="compare">
